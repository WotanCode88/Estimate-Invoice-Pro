        ...
        HStack {
            Button(action: {
                ...
                Image(systemName: "chevron.left")
                    ...
                    .padding(16) // увеличиваем отступ вокруг иконки
                    .contentShape(Rectangle()) // область касания по всему padding
            }
            Spacer()
            Text("New invoice")
                .font(.headline)
            ...
            Button(action: {
                ...
                if hasIssued && hasDue && hasClient && hasItems && hasTotal && hasCurrency {
                    onBack()
                } else {
                    showAlert = true
                }
