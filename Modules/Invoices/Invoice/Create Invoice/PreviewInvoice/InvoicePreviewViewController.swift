...
class InvoicePreviewViewController: UIViewController {
    init(isCustom: Bool, invoice: InvoiceModel) {
...
extension UIView {
    func asPDFData() -> Data {
        ...
        let renderer = UIGraphicsPDFRenderer(bounds: bounds, format: pdfRendererFormat)
...
extension InvoicePreviewViewController: UIColorPickerViewControllerDelegate {
    func colorPickerViewControllerDidSelectColor(_ viewController: UIColorPickerViewController) {
        let selectedColor = viewController.selectedColor
        changeColor(selectedColor)
        selectedColorAsset = "customColorsAsset"
        updateCheckmarks()
    }
}

extension InvoicePreviewViewController {
    func setupInvoice() {
